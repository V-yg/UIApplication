...
public class WeekAdapter3 extends RecyclerView.Adapter<WeekAdapter3.ViewHolder> {
    ...
    public WeekAdapter3(List<Week> weekList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view  = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.week_item3_layout,parent,false);
